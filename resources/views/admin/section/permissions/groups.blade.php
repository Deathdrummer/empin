			...
			<div class="col">
				<x-card
					...
					<x-simplelist
						...
						fieldset="ID группы:w5rem|number|id|1,Название вкладки:w50rem|textarea|name,Группа пользователей:w30rem|select|group,Кол-во столбцов:w10rem|number|cols_count,Сортировка:w5rem|number|sort"
