@forelse($userColums as $column)
	...
	@if($column == 'applicant' && auth('site')->user()->can('contract-col-applicant:site'))
		<x-table.td class="breakword h-start" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:applicant:site')) ? $id.','.$column.',1' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<div class="scrollblock-hidden maxh4rem-6px pr3px">
	...
	@if($column == 'titul' && auth('site')->user()->can('contract-col-titul:site'))
		<x-table.td class="pr2px breakword" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:titul:site')) ? $id.','.$column.',1' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<div class="scrollblock-hidden maxh4rem-6px pr3px">
	...
	@if($column == 'contract' && auth('site')->user()->can('contract-col-contract:site'))
		<x-table.td class="breakword" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:contract:site')) ? $id.','.$column.',1' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<p class="fz12px lh110" edittedplace="-">{{$contract ?? '-'}}</p>
		</x-table.td>
	@endif

	@if($column == 'customer' && auth('site')->user()->can('contract-col-customer:site'))
		<x-table.td class="breakword" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:customer:site')) ? $id.','.$column.',4' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'locality' && auth('site')->user()->can('contract-col-locality:site'))
		<x-table.td class="breakword h-center" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:locality:site')) ? $id.','.$column.',1' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<div class="scrollblock-hidden maxh4rem-6px pr3px">
	...
	@if($column == 'date_send_action' && auth('site')->user()->can('contract-col-date_send_action:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_send_action:site')) ? $id.','.$column.',3' : false" editacts="date_send_action" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'count_ks_2' && auth('site')->user()->can('contract-col-count_ks_2:site'))
		<x-table.td class="breakword h-center" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:count_ks_2:site')) ? $id.','.$column.',1' : false" editacts="count_ks_2" style="background-color: {{$selected_color.'75' ?? ''}};">
			<p class="fz12px" edittedplace="-" val="{{$count_ks_2 ?? '-'}}">{{$count_ks_2 ?? '-'}}</p>
		</x-table.td>
	@endif
	
	@if($column == 'act_pir' && auth('site')->user()->can('contract-col-act_pir:site'))
		<x-table.td class="h-center" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:act_pir:site')) ? $id.','.$column.',4' : false" editacts="act_pir" style="background-color: {{$selected_color.'75' ?? ''}};">
			<div edittedplace="">
				@if($act_pir)
	...
	@if($column == 'price' && auth('site')->user()->can('contract-col-price:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'price_nds' && auth('site')->user()->can('contract-col-price_nds:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_nds:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'price_gen' && auth('site')->user()->can('contract-col-price_gen:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_gen:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<input type="hidden" replacer calcprice="price">
			<input type="hidden" replacer calcprice="price_nds">
			<input type="hidden" replacer calcprice="price_gen_nds">
			<input type="hidden" replacer calcprice="price_sub">
	...
	@if($column == 'price_gen_nds' && auth('site')->user()->can('contract-col-price_gen_nds:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_gen_nds:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<input type="hidden" replacer calcprice="price">
			<input type="hidden" replacer calcprice="price_nds">
			<input type="hidden" replacer calcprice="price_gen">
			<input type="hidden" replacer calcprice="price_sub">
	...
	@if($column == 'price_sub' && auth('site')->user()->can('contract-col-price_sub:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_sub:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<input type="hidden" replacer calcprice="price">
			<input type="hidden" replacer calcprice="price_nds">
			<input type="hidden" replacer calcprice="price_gen">
			<input type="hidden" replacer calcprice="price_gen_nds">
	...
	@if($column == 'price_sub_nds' && auth('site')->user()->can('contract-col-price_sub_nds:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_sub_nds:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<input type="hidden" replacer calcprice="price">
			<input type="hidden" replacer calcprice="price_nds">
			<input type="hidden" replacer calcprice="price_gen">
			<input type="hidden" replacer calcprice="price_gen_nds">
	...
	@if($column == 'price_avvr' && auth('site')->user()->can('contract-col-price_avvr:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_avvr:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'price_avvr_nds' && auth('site')->user()->can('contract-col-price_avvr_nds:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_avvr_nds:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'avvr_nds_only' && auth('site')->user()->can('contract-col-avvr_nds_only:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:avvr_nds_only:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			@isset($avvr_nds_only)
	...
	@if($column == 'price_pir' && auth('site')->user()->can('contract-col-price_pir:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_pir:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'price_pir_nds' && auth('site')->user()->can('contract-col-price_pir_nds:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_pir_nds:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'pir_nds_only' && auth('site')->user()->can('contract-col-pir_nds_only:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:pir_nds_only:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			@isset($pir_nds_only)
	...
	@if($column == 'price_smr' && auth('site')->user()->can('contract-col-price_smr:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_smr:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			@isset($price_smr)
	...
	@if($column == 'price_pnr' && auth('site')->user()->can('contract-col-price_pnr:site'))
		<x-table.td class="text-end" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:price_pnr:site')) ? $id.','.$column.',2' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			@isset($price_pnr)
	...
	@if($column == 'date_report_from' && auth('site')->user()->can('contract-col-date_report_from:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_report_from:site')) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_start' && auth('site')->user()->can('contract-col-date_start:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_start:site')) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_end' && auth('site')->user()->can('contract-col-date_end:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_end:site')) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_gen_start' && auth('site')->user()->can('contract-col-date_gen_start:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_gen_start:site')) && (isset($date_gen_start) || $subcontracting) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_gen_end' && auth('site')->user()->can('contract-col-date_gen_end:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_gen_end:site')) && (isset($date_gen_end) || $subcontracting) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_sub_start' && auth('site')->user()->can('contract-col-date_sub_start:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_sub_start:site')) && (isset($date_sub_start) || $gencontracting) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_sub_end' && auth('site')->user()->can('contract-col-date_sub_end:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_sub_end:site')) && (isset($date_sub_end) || $gencontracting) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'type' && auth('site')->user()->can('contract-col-type:site'))
		<x-table.td class="h-center breakword" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:type:site')) ? $id.','.$column.',4' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'contractor' && auth('site')->user()->can('contract-col-contractor:site'))
		<x-table.td class="h-center breakword" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:contractor:site')) ? $id.','.$column.',4' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'buy_number' && auth('site')->user()->can('contract-col-buy_number:site'))
		<x-table.td class="breakword h-center" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:buy_number:site')) && $buy_number != 'БЕЗ ЗАКУПКИ' ? $id.','.$column.',1' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_buy' && auth('site')->user()->can('contract-col-date_buy:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_buy:site')) && (isset($date_buy) || !$without_buy) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'date_close' && auth('site')->user()->can('contract-col-date_close:site'))
		<x-table.td commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:date_close:site')) ? $id.','.$column.',3' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
	...
	@if($column == 'archive_dir' && auth('site')->user()->can('contract-col-archive_dir:site'))
		<x-table.td class="breakword h-center" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:archive_dir:site')) ? $id.','.$column.',1' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
			<div class="scrollblock-hidden maxh4rem-6px pr3px">
	...
	@if($column == 'power' && auth('site')->user()->can('contract-col-power:site'))
		<x-table.td class="breakword h-center" commonlist :contextedit="(auth('site')->user()->can('contract-can-edit-cell::site') || auth('site')->user()->can('edit:power:site')) ? $id.','.$column.',1' : false" style="background-color: {{$selected_color.'75' ?? ''}};">
